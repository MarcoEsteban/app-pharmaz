...
import { BtnLote } from '@/components';
...
import { FaCalendarDays, FaCalendarXmark, FaTruckMedical } from 'react-icons/fa6';
      ...
      >
        ...
        <div className="p-4 flex-1">
          ...
          <p className="mt-2 flex flex-col gap-1 text-sm font-sans tracking-wide antialiased">
            ...
            <span className="flex gap-1"><FaCalendarDay size={ 20 } /> Dia: { lote.dia }</span>
          </p>
        </div>
