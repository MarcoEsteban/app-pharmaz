...
export const AtributosTableSkeleton = ( { nombre }: Props ) => {
  return (
              ...
              <tr key={ index } className="border-b animate-pulse">
                ...
                </td>
                {
                  nombre === 'Laboratorio'
                    ? (
                      <td className="table-td">
                        <div className="h-10 w-10 bg-gray-200/70 rounded-full"></div>
                      </td>
                    ) : ( '' )
                }
                <td className="table-td text-center">
                  <div className="h-4 bg-gray-200/70 rounded w-1/2 mx-auto"></div>
                </td>
                <td className="table-td text-center">
