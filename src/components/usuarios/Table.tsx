...
export default function UsuariosTable() {
  return (
      <div className="flex-auto p-2 border border-solid m-4 rounded-lg">
                ...
                <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                  <div className="flex px-2 py-1">
                    ...
                    <div className="flex flex-col justify-center">
                      <h6 className="mb-0 leading-normal font-medium text-sm">John Michael</h6>
              ...
              <tr>
                <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                  <div className="flex px-2 py-1">
                    ...
                    <div className="flex flex-col justify-center">
                      <h6 className="mb-0 leading-normal font-medium text-sm">Alexa Liras</h6>
