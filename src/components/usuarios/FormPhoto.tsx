...
export const FormPhoto = ({ id }: Props) => {
  ...
  const [selectedFile, setSelectedFile] = useState<File | null>(null); // Estado para guardar el dato de la Foto.
  ...
  const onSubmit = async (data: FormInputs) => {
    ...
    console.log("Tamaño de la imagen:", data.foto); // Verifica el tamaño.
    console.log("SelectedFile:", selectedFile); // Verifica el tamaño.
