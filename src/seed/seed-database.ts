...
async function main() {
  ...
  const {
    menus, roles, personas, usuarios, proveedor, datafarmacia: datapharmaz, 
    producto, presentacion, laboratorio, principioActivo, viaAdministracion, lotes
  } = initialData;
  ...
  const presentacionId = await prisma.presentacion.findMany({select: {id: true}})
  ...
  const laboratoriosId = await prisma.laboratorios.findMany({select: {id: true}})
  ...
  const principioActivoId = await prisma.principioActivo.findMany({select: {id: true}})
  ...
  const viaAdministracionId = await prisma.viaAdministracion.findMany({select: {id: true}})
  ...
  // ============================
  const productosDB = await prisma.medicamentos.findMany({select: {id: true}})
  const presentacionDB = await prisma.presentacion.findMany({select: {id: true}})
  ...
  // ==========================
  const laboratoriosDB = await prisma.laboratorios.findMany({select: {id: true}})
  ...
  // ============================
  const principioActivoDB = await prisma.principioActivo.findMany({select: {id: true}})
  ...
  // ============================
  const viaAdministracionDB = await prisma.viaAdministracion.findMany({select: {id: true}})
  ...
  // Insert Table Lotes:
  // ===================
  const proveedorDB = await prisma.proveedores.findMany({select: {id: true}})
