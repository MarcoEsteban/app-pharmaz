        ...
        <div className={ "flex-2 font-sans relative" }>
          <div className={ "w-full mb-8" }>
            ...
            <p className={ "border-b-2 border-blue-800 pl-1 pt-2 font-medium tracking-wide" }>
              { user.personas.nombre + ' ' + user.personas.ap + ' ' + user.personas.am}
            </p>
          </div>
          ...
          <div className={ "flex gap-12" }>
            ...
            <div className={ "w-80 mb-8" }>
              ...
              <p className={ "border-b-2 border-blue-800 pl-1 pt-2 font-medium tracking-wide" }>{ user.email }</p>
            </div>

            <div className={ "w-72 mb-8" }>
              <span className={ "flex items-center gap-1 font-semibold" }><FaPhoneFlip size={ 17 } className={ "text-blue-800" } /> Celular</span>
              <p className={ "border-b-2 border-blue-800 pl-1 pt-2 font-medium tracking-wide" }>{ user.personas.celular }</p>
            </div>
          ...
          <div className={ "w-full mb-8" }>
            ...
            <p className={ "border-b-2 border-blue-800 pl-1 pt-2 font-medium tracking-wide" }>{ user && user.personas.direccion }</p>
          </div>
